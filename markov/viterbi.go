...
func (v *Viterbi) Decode(observations []string) []string {
	...
	for _, s := range v.States {
		...
		e, _ := s.GetEmitionProbability(observations[0])
		t := v.GetInitialProb(s.Name)
